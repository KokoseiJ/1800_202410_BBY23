document.addEventListener("DOMContentLoaded", function () {
    ...
    modalFAQ.addEventListener("show.bs.modal", function (event) {
        ...
        if (currentUserId === groupOwnerId) {
            // Display "Edit Group" button only on joinedgroups.html
            if (window.location.pathname.includes("joinedgroups.html")) {
                ...
                editButton.addEventListener("click", function () {
                    ...
                    // Replace static description with input fields for all editable properties
                    modalBody.innerHTML = `
                        <div class="mb-3">
